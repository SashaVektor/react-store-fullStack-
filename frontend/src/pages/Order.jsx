...
import { orderPageReducer } from '../context/orderPageReducer'
...
const Order = () => {
  ...
  }, [navigate, order._id, orderId, paypalDispatch, successDeliver, successPay, userInfo])
              ...
              <Col md={8}>
                ...
                <Card className='mb-3'>
                  <Card.Body>
                    ...
                    <Card.Text><strong>Method: </strong>
                      {order.paymentMethod}
                    </Card.Text>
                    {order.isPaid ? (
                      <MessageBox variant="success">
